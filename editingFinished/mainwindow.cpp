...
// });
 ...
 connect(firstNameEdit,&QLineEdit::cursorPositionChanged,[=](){
     qDebug().nospace().noquote()<<"cursorPosition is : " <<firstNameEdit->cursorPosition();
 });
 connect(LastNameEdit,&QLineEdit::cursorPositionChanged,[=](){
     qDebug().nospace().noquote()<<"cursorPosition is : " <<LastNameEdit->cursorPosition();
 });
 connect(CityNameEdit,&QLineEdit::cursorPositionChanged,[=](){
     qDebug().nospace().noquote()<<"cursorPosition is : " <<CityNameEdit->cursorPosition();
 });
 connect(CityNameEdit,&QLineEdit::editingFinished,[=](){
     qDebug().nospace().noquote()<<"editing findished";
 });
}
